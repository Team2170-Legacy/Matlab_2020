...
%
%   For FRC 2020 Infinite
%   Modified for FRC 2020 Control by Jacob Krucinski
%
%   v008    Clean-up by Jacob K. 1/28/2020
...
for i=1:N
    ...
    %    t
        ...
        [v_ft,omega] = Controller_v003(distance_ft, angle, Robot);

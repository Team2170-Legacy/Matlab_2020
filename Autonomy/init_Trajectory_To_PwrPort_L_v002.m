...
To_PwrPort_L.Arc2.radius = 2.25;
To_PwrPort_L.Arc2 = get_Curve(90*deg, 60*deg, 1, To_PwrPort_L.Arc2.n, To_PwrPort_L.Arc2.radius, .7, RobotStartY - To_PwrPort_L.Arc2.radius);

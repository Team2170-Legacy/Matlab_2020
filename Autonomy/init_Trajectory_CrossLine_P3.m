...
CrossLine_P3.x =   [   LineR...
                    15*ft
                ];

CrossLine_P3.y =   [   RobotStartY-Robot.W-RobotSep...
...
CrossLine_P3.v = 1.6;
CrossLine_P3.t_final = traj_length(CrossLine_P3) / CrossLine_P3.v  * 1.3;
CrossLine_P3.name = 'Cross Line P1';
CrossLine_P3.theta_start = 180*deg;